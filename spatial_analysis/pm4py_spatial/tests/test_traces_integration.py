"""Integration tests for pm4py_spatial against real-world trace files.
...
def test_bottling():
    ...
    cols = pm4py_spatial.detect_spatial_columns(df_raw)
...
def test_citibike():
    ...
    df_utm = pm4py_spatial.normalize_crs(log, "EPSG:32618")
...
def test_truck_compact():
    ...
    df_mercator = pm4py_spatial.normalize_crs(log, "EPSG:3857")
